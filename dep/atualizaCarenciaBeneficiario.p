...
if not avail usuario 
    then return error "0003-Cliente nÆo encontrado: Mod.: " + string(st_cd-modalidade-par) + " Termo: " + string(st_nr-ter-adesao-par) + " Usu rio: " + string(st_cd-usuario-par).

if  st_cd-tipo-regra-par <> 01 
and st_cd-tipo-regra-par <> 02
and st_cd-tipo-regra-par <> 03
and st_cd-tipo-regra-par <> 04
    then return error "0037-NÆo existe tratativa de controle de carˆncia = " + string(st_cd-tipo-regra-par).
    ...
    then do:
            for each ct_tt-modulo no-lock:
                ...
                if ct_tt-modulo.st_nr-dias-carencia-original < 0 
                    then return error "0057-N£mero de dias de carˆncia original inv lido".
            
                if ct_tt-modulo.st_nr-dias-carencia-alterada < 0 
                    then return error "0057-N£mero de dias de carˆncia destino inv lido".
                ...
                if avail propost
                    then do:
                            if propost.cd-contratante = 0 
                                then return error "0011ÎCodigo contratante nao encontrado".
    ...
    if avail pessoa-fisica
        then do:
                ...
                assign tmpPessoaFisica.des-alerg                  =   char   x(100)            Alergico                          
                       ...
                       tmpPessoaFisica.des-doenca                 =   char   x(255)            Descricao doen»a                  
                       ...
                       tmpPessoaFisica.des-obs                    =   char   x(2000)           Observa‡Æo
